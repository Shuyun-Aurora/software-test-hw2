...
本文档为软件测试课程作业二《GUI 测试》的测试计划，用于指导 SauceDemo 电商网站的 Selenium 自动化测试设计、脚本编写、测试执行和后续测试报告整理。测试计划由成员 A 负责编写，后续测试代码和测试报告由小组成员按分工共同完成。
...
\small
\setlength{\tabcolsep}{2pt}
\begin{longtable}{p{2.0cm}p{1.4cm}p{6.0cm}p{3.8cm}}
\caption{Web 元素覆盖情况}\\
\toprule
...
\midrule
\endhead
按钮 & 必选 & Login、Add to cart、Remove、Checkout、Continue、Finish、侧边栏关闭按钮 & TC01、TC04、TC05、TC06、TC07 \\
输入框 & 必选 & username、password、first name、last name、postal code & TC01、TC06 \\
表单 & 必选 & 登录表单、结算信息表单 & TC01、TC06 \\
下拉框 & 必选 & 商品排序下拉框 product\_sort\_container & TC02 \\
链接 & 必选 & 商品名称链接、商品图片链接、购物车链接、侧边栏菜单项 & TC03、TC05、TC07 \\
侧边栏/导航栏 & 可选 & 左侧菜单按钮、All Items、About、Logout、Reset App State & TC07 \\
购物车 badge & 可选 & 购物车数量标记 & TC04、TC05 \\
